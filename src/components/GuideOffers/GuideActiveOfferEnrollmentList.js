                ...
                dropdown ?
                    <Row className={"mb-5"} style={{backgroundColor: "whitesmoke", borderTop: "2px solid #222222"}}>
                        <Col xl={3} className={"d-flex flex-column p-xl-5 justify-content-start "}>
                            <Row className={"d-flex align-items-center mt-3"}><PersonIcon fontSize={"large"}/> <p>Bob
                                Marley</p></Row>
                            <Row className={"d-flex align-items-center mt-3"}><EmailIcon fontSize={"large"}/>
                                <p>bobm@gmail.com</p></Row>
                            <Row className={"d-flex align-items-center mt-3"}><PhoneIcon fontSize={"large"}/> 646912887
                            </Row>
                        </Col>
                        <Col xl={3} className={"d-flex flex-column p-xl-5 justify-content-start"}>
                            <Row className={"d-flex align-items-center mt-3"}><CheckBoxIcon fontSize={"large"}/>
                                <p>Użytkownik/Gość</p></Row>
